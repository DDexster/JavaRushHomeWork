...
public class Solution
{
    ...
    {
        private String name;
        private Cat parentD = null;
        private Cat parentM = null;
        ...
        public Cat(String name, Cat parentD, Cat parentM)
        {
            this.name = name;
        ...
        {
            if (parentD == null && parentM == null)
                return "Cat name is " + name + ", no mother, no father ";
            else if (parentM == null && parentD != null)
                return "Cat name is " + name + ", no mother, father is " + parentD.name;
            else if (parentD == null && parentM != null)
                return "Cat name is " + name + ", mother is " + parentM.name + ", no father ";
            else
                return "Cat name is " + name + ", mother is " + parentM.name + ", father is " + parentD.name;
        }
    }
